...
def main():
    ...
    # Configuración
    html_file = "docs/usuarios_integrado_2020-2025.html"
    if len(sys.argv) >= 2:
    ...
    if discoveries_block:
        ...
        extracted_file = '/mnt/user-data/outputs/extracted_discoveries.js'
    ...
    fixed_file = '/mnt/user-data/outputs/fixed_discoveries.js'
