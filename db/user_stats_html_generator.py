    ...
    <div class="container">
        ...
        <div class="stats-container">
            ...
            <div id="individualView" class="view active">
                ...
                <div class="evolution-section">
                    <h3>ðŸŽˆ EvoluciÃ³n de Sellos Individuales</h3>
                    <div class="evolution-charts">
                        <div class="evolution-chart">
                ...
                <div class="evolution-section">
                    <h3>ðŸ§” EvoluciÃ³n de Artistas Individuales</h3>
                    <div class="evolution-charts">
                        <div class="evolution-chart">
                ...
                <div class="evolution-section">
                    <h3>ðŸŽï¸ Artistas con Mayor Streak</h3>
                    <div class="evolution-charts">
                        <div class="evolution-chart">
                ...
                <div class="evolution-section">
                    <h3>ðŸ–¸ Artistas con Mayor DiscografÃ­a</h3>
                    <div class="evolution-charts">
                        <div class="evolution-chart">
                            <h4>Top 10 Artistas con MÃ¡s Canciones Ãºnicas</h4>
                            <div class="line-chart-wrapper">
            ...
            <div id="evolutionView" class="view">
                ...
                <div class="evolution-section">
                    <h3> EvoluciÃ³n de DÃ©cadas (Coincidencias)</h3>
                    <div class="evolution-charts">
                        <div class="evolution-chart">
    ...
    <script>
        ...
        function showLinearPopup(title, details) {{
            ...
            details.slice(0, 10).forEach(item => {{
                ...
                if (item.artist) {{
                    // Es una coincidencia real - mostrar informaciÃ³n completa
                    content += `<div class="popup-item">
                ...
                options: {{
                    ...
                    scales: {{
                        ...
                        y: {{
                            ...
                            title: {{
                                display: true,
                                text: title === 'Artistas con Mayor Streak' ? 'DÃ­as' :
                                      title === 'Artistas con Mayor DiscografÃ­a' ? 'Canciones Ãºnicas' :
                                      'Reproducciones',
                                color: '#a6adc8'
                            }}
                        }}
